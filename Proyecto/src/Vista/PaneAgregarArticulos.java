...
import static Vista.MiniPaneCliente.apellidos;
import static Vista.MiniPaneCliente.cedula;
import static Vista.MiniPaneCliente.dir;
import static Vista.MiniPaneCliente.nombres;
import static Vista.MiniPaneCliente.telefono;
...
public class PaneAgregarArticulos {
    ...
    private void guardar() {
        guardar.setOnAction(e->{
            if(validar()){
                cone.connect();
                Articulo t = buscarArticulo(codigo.getText(), cone.getC());
                if (t.getCod_articulo() == null) {
